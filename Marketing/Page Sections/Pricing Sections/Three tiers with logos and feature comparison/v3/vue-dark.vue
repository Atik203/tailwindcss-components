<template>
  <div class="bg-gray-900 py-24 sm:py-32">
    ...
    <div class="relative pt-16 sm:pt-24">
      <div class="absolute inset-x-0 bottom-0 top-48 bg-[radial-gradient(circle_at_center_center,#7775D680,#592E7180,transparent_70%)] lg:bg-[radial-gradient(circle_at_center_150%,#7775D680,#592E7180,transparent_70%)]"></div>
