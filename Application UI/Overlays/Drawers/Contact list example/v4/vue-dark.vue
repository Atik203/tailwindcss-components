                      ...
                      <li v-for="person in team" :key="person.handle">
                        <div class="group relative flex items-center px-5 py-6">
                          <a :href="person.href" class="-m-1 block flex-1 p-1">
                            <div class="absolute inset-0 group-hover:bg-white/2.5" aria-hidden="true"></div>
                            <div class="relative flex min-w-0 flex-1 items-center">
                              <span class="relative inline-block shrink-0">
                                ...
                                <span :class="[person.status === 'online' ? 'bg-green-400' : 'bg-gray-500', 'absolute top-0 right-0 block size-2.5 rounded-full ring-2 ring-gray-800']" aria-hidden="true"></span>
                              </span>
